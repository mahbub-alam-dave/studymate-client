...
const AssignmentSubmitModal = ({closeModal, openModal, submitAssignment}) => {
  ...
  if (!openModal) return null;
    ...
    return (
<div className="fixed inset-0 bg-gradient-to-br from-[#A8F1FF] to-[#00b4d8] dark:bg-gradient-to-br dark:from-[#03045e] dark:to-[#000814] flex items-center justify-center  z-50">
