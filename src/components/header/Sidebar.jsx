...
const Sidebar = ({ displayMenu, setDisplayMenu, handleLogout }) => {
  ...
  return (
    <div
      className={` max-w-[300px] w-full bg-[var(--color-secondary)] dark:bg-[var(--color-secondary-dark)] text-[var(--color-text-primary-dark)] shadow-sm shadow-gray-200 h-screen fixed top-0 transition-all duration-600 ease-in-out block lg:hidden  ${
