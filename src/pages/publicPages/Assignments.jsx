    ...
    <div className="py-12 px-4 sm:px-5 md:px-6 w-full">
      <div className="flex flex-col gap-4 pb-12 justify-center items-center">
        ...
        <div className="flex items-center">
          <label className="flex items-center gap-2 p-2 rounded border bg-white border-gray-300 focus-within:outline-none focus-within:ring-0">
            <svg
          ...
          <select
            ...
            className="select focus:outline-none ml-2 border-white bg-[#FF3F33] text-white"
          >
